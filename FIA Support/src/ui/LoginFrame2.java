...
public class LoginFrame2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Text_FIA_Support.setFont(new java.awt.Font("Corbel", 0, 36)); // NOI18N
        ...
        grayPanel1stLayout.setHorizontalGroup(
            ...
            .addGroup(grayPanel1stLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(grayPanel1stLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(grayPanel1stLayout.createSequentialGroup()
                        .addComponent(redPanel2nd, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addContainerGap())
                    .addGroup(grayPanel1stLayout.createSequentialGroup()
        ...
        grayPanel1stLayout.setVerticalGroup(
            grayPanel1stLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(grayPanel1stLayout.createSequentialGroup()
                .addGroup(grayPanel1stLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(Text_FIA_Support)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(TextLink_Problemas, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 321, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(Label_Image, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addComponent(grayPanel1st, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(24, 24, 24)
                .addComponent(Label_Image, javax.swing.GroupLayout.DEFAULT_SIZE, 416, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(redPanel3rd, javax.swing.GroupLayout.PREFERRED_SIZE, 269, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TextLink_Problemas, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
...
// Abre el diálogo diseñado
        ProblemasCarnetContrasenaDialog dlg
                = new ProblemasCarnetContrasenaDialog(this, true); // this = tu JFrame
        dlg.setLocationRelativeTo(this); // centrado sobre el login
        dlg.setVisible(true);
...
//GEN-FIRST:event_formWindowOpened
        // --- Escalar el icono del encabezado (50 px alto máx) ---
        javax.swing.Icon rawIco = lblIcono.getIcon();
        if (rawIco instanceof javax.swing.ImageIcon) {
            javax.swing.ImageIcon imgIcon = (javax.swing.ImageIcon) rawIco;
        ...
        // --- Ajustar el logo grande en Label_Image, centrado sin deformar ---
        try {
            Label_Image.setText("");
            javax.swing.ImageIcon raw = new javax.swing.ImageIcon(
                    getClass().getResource("/img/Fia_Support_Logo.png")
            ...
            java.awt.Image scaled2 = raw.getImage()
                    .getScaledInstance(drawW, drawH, java.awt.Image.SCALE_SMOOTH);
            Label_Image.setIcon(new javax.swing.ImageIcon(scaled2));

            int padX = Math.max(0, (boxW - drawW) / 2);
            int padY = Math.max(0, (boxH - drawH) / 2);
            Label_Image.setBorder(
                    javax.swing.BorderFactory.createEmptyBorder(padY, padX, padY, padX)
            );
            Label_Image.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
            Label_Image.setVerticalAlignment(javax.swing.SwingConstants.CENTER);
        } catch (Exception ex) {
