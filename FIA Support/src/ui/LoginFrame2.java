...
// Guardaremos el echo char "real" del password para restaurarlo
private char echoDefault = '\u2022'; // bullet por defecto
    ...
    public LoginFrame2() {
        initComponents();
        // Escalar el logo al tamaño actual del JLabel
javax.swing.SwingUtilities.invokeLater(() -> {
    int w = Label_Image.getWidth();
    int h = Label_Image.getHeight();
    if (w > 0 && h > 0) {
        ...
        // --- Placeholder inicial para CARNET (ya lo pusiste en Properties, aquí solo reforzamos color)
    txtField_Carnet.setForeground(COLOR_PLACEHOLDER);

    // --- Placeholder inicial para CONTRASEÑA
    // guarda el echo char actual (si viene 0 o inválido, usamos bullet)
    char ec = PswrdField_Digite_su_contraseña.getEchoChar();
    if (ec != 0) {
        echoDefault = ec;
    }
    // muestra texto de placeholder sin bullets (echo 0) y color gris
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(Label_Image, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(158, 158, 158))
        );
...
if (ok) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        // Mueve el foco a un panel neutro para que NO se borre el placeholder al iniciar
    javax.swing.SwingUtilities.invokeLater(() -> jPanel3.requestFocusInWindow());
